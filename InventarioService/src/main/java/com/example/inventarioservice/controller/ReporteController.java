...
public class ReporteController {
        ...
        @Operation(summary = "Obtener estadísticas generales del inventario", description = "Retorna contadores de productos, stock total y alertas")
        ...
        @Operation(summary = "Obtener productos con stock bajo", description = "Retorna lista de productos cuya cantidad es menor o igual al stock mínimo")
        ...
        @Operation(summary = "Estadísticas de movimientos de inventario", description = "Retorna información sobre entradas y salidas de inventario")
        ...
        @Operation(summary = "Estadísticas de un producto específico", description = "Retorna información detallada de inventario y movimientos de un producto")
        public ResponseEntity<ProductoEstadisticasDTO> obtenerEstadisticasProducto(
                        @Parameter(description = "ID del producto a consultar", example = "10") @PathVariable Long productoId) {
        ...
        @Operation(summary = "Top productos con mayor stock", description = "Retorna los productos con mayor cantidad en inventario (por defecto top 10)")
        public ResponseEntity<List<TopStockDTO>> obtenerTopProductosStock(
                        @Parameter(description = "Cantidad límite de productos a mostrar", example = "5") @RequestParam(name = "limit", required = false) Integer limit) {
