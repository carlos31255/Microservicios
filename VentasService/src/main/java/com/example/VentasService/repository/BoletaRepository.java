...
public interface BoletaRepository extends JpaRepository<Boleta, Integer> {
    ...
    List<Boleta> findByClienteId(Integer clienteId);
    
    // Buscar boletas por estado
    List<Boleta> findByEstado(String estado);
    
    // Buscar boletas por cliente y estado
    List<Boleta> findByClienteIdAndEstado(Integer clienteId, String estado);
    ...
    List<Boleta> findByClienteIdAndFechaVentaBetween(Integer clienteId, LocalDateTime fechaInicio, LocalDateTime fechaFin);
    ...
    List<Boleta> findByClienteIdOrderByFechaVentaDesc(Integer clienteId);
